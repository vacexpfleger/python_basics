...
x = 0
# global = 1 - "global" patří mezi klíčová slova v Pythonu
y = 1
PI = 3.14
city = "Opava"
# hilda@sspu-opava.cz = 'Hilda Dokonalá' - název proměnné obsahuje nealfanumerické znaky (@-.)
name = 'Hilda Dokonalá'
password2 = 'TajneHeslo'
# 007agent = 'James Bond' - název proměnné začíná numerickým znakem
agent007 = 'James Bond'
