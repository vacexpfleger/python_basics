...
myself_binary = 0b10110111
myself_hexadecimal = 0x1a
myself_binHexAnd = myself_binary & myself_hexadecimal
print(myself_binary)
print(myself_binary >> 2)
print(myself_binHexAnd)
print("Binární součin čísla {} a {} je {}.".format(bin(myself_binary), bin(myself_hexadecimal), bin(myself_binHexAnd)))
